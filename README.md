...
OASIOS uses **two lightweight SQLite databases**:
...
> Bukhtoyarov, M. (2025). *Open ASI Ontology and Scenario Observatory (v0.3).* GitHub: [https://github.com/oasis-observatory/oasis-observatory](https://github.com/oasis-observatory/oasis-observatory)
